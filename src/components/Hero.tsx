...
const Hero = () => {
  return (
    <section className="relative h-[100dvh] sm:h-screen flex items-start justify-center overflow-hidden bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a]">
      ...
      {/* Content */}
    <div className="relative z-10 w-full max-w-5xl mx-auto px-5 sm:px-6 lg:px-8 text-center flex flex-col items-center h-full 
  justify-center sm:justify-start pt-0 sm:pt-32">
  {/* Heading */}
  ...
  <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 animate-fade-in [animation-delay:0.6s] opacity-0 [animation-fill-mode:forwards]">
    ...
    <Button
      size="lg"
      variant="outline"
      className="w-full sm:w-auto font-semibold text-lg sm:text-lg px-10 py-4 sm:px-8 sm:py-4 border border-white/40 text-black hover:bg-white/10 backdrop-blur-md shadow-lg transition-all duration-300 hover:scale-105"
    >
      Learn More
    </Button>
  </div>
