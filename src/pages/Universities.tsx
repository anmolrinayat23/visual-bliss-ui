...
const ugUniversities: (University & { category: string })[] = [
  ...
  { name: "Thapar Institute of Technology", shortName: "THAPAR", location: "Patiala, Punjab", city: "Patiala", state: "Punjab", category: "BTech", logo: "/Thapar Institute of Technology1.jfif" },
  { name: "VIT Bhopal", shortName: "VIT", location: "Bhopal, Madhya Pradesh", city: "Bhopal", state: "Madhya Pradesh", category: "BTech", logo: "/vit.png" },
  { name: "MANIT Bhopal", shortName: "MANIT", location: "Bhopal, Madhya Pradesh", city: "Bhopal", state: "Madhya Pradesh", category: "BTech", logo: "/manit.jfif" },
  { name: "BITS Pilani", shortName: "BITS Pilani", location: "Pilani, Rajasthan", city: "Pilani", state: "Rajasthan", category: "BTech", logo: "/bits-pilani.jfif" },
  { name: "BITS Goa", shortName: "BITS Goa", location: "Goa", city: "Goa", state: "Goa", category: "BTech", logo: "/bits-pilani.jfif" },
  { name: "SRM University", shortName: "SRM", location: "All Campuses", city: "Chennai", state: "Tamil Nadu", category: "BTech", logo: "/srm.png" },
  { name: "Amrita University", shortName: "Amrita", location: "All Campuses", city: "Coimbatore", state: "Tamil Nadu", category: "BTech", logo: "/amrita.png" },
  { name: "IIIT Delhi", shortName: "IIIT Delhi", location: "Delhi", city: "Delhi", state: "Delhi", category: "BTech", logo: "/iiit-delhi.jfif" },
  { name: "Universal AI University", shortName: "UAI", location: "Mumbai, Maharashtra", city: "Mumbai", state: "Maharashtra", category: "BTech", logo: "/uai.jfif" },
  { name: "UPES Dehradun", shortName: "UPES", location: "Dehradun, Uttarakhand", city: "Dehradun", state: "Uttarakhand", category: "BTech", logo: "/upes.jfif" },
  { name: "GL Bajaj Institute", shortName: "GL Bajaj", location: "Greater Noida, Uttar Pradesh", city: "Greater Noida", state: "Uttar Pradesh", category: "BTech", logo: "/gl-bajaj.jfif" },
  { name: "PES University", shortName: "PES", location: "Bangalore, Karnataka", city: "Bangalore", state: "Karnataka", category: "BTech", logo: "/pes.png" },
  { name: "NMAM Institute of Technology", shortName: "NMAM", location: "Karnataka", city: "Nitte", state: "Karnataka", category: "BTech", logo: "/nmam.png" },
  { name: "Chandigarh University", shortName: "CU", location: "Chandigarh, Punjab", city: "Chandigarh", state: "Punjab", category: "BTech", logo: "/chandigarh.png" },
  { name: "PIET University", shortName: "PIET", location: "Panipat, Haryana", city: "Panipat", state: "Haryana", category: "BTech", logo: "/piet.jfif" },
  { name: "GNIOT Greater Noida", shortName: "GNIOT", location: "Greater Noida, Uttar Pradesh", city: "Greater Noida", state: "Uttar Pradesh", category: "BTech", logo: "/gniot.png" },
  // Commerce
  { name: "Mount Carmel College", shortName: "MCC", location: "Bangalore, Karnataka", city: "Bangalore", state: "Karnataka", category: "Commerce", logo: "/Mount Carmel College.jfif" },
  { name: "SCMS Pune (BBA)", shortName: "SCMS", location: "Pune, Maharashtra", city: "Pune", state: "Maharashtra", category: "Commerce", logo: "/scms.jfif" },
  { name: "St Joseph's College of Commerce", shortName: "SJCC", location: "Bangalore, Karnataka", city: "Bangalore", state: "Karnataka", category: "Commerce", logo: "/sjcc.jfif" },
  { name: "Christ University", shortName: "CHRIST", location: "Bangalore, Karnataka", city: "Bangalore", state: "Karnataka", category: "Commerce", logo: "/christ.jfif" },
  { name: "jain University", shortName: "JAIN", location: "Bangalore, Karnataka", city: "Bangalore", state: "Karnataka", category: "Commerce", logo: "/jain.png" },
  { name: "Ashoka University", shortName: "Ashoka", location: "Sonepat, Haryana", city: "Sonepat", state: "Haryana", category: "Commerce", logo: "/ashoka.png" },
  { name: "Bennett University", shortName: "BENNETT", location: "Greater Noida, Uttar Pradesh", city: "Greater Noida", state: "Uttar Pradesh", category: "Commerce", logo: "/BENNETT UNIVERSITY.webp" },
  { name: "IMS Ghaziabad", shortName: "IMS", location: "Ghaziabad, Uttar Pradesh", city: "Ghaziabad", state: "Uttar Pradesh", category: "Commerce", logo: "/ims.jfif" },
  { name: "Graphic Era University", shortName: "GEU", location: "Dehradun, Uttarakhand", city: "Dehradun", state: "Uttarakhand", category: "Commerce", logo: "/geu.jfif" },
  { name: "UPES Dehradun", shortName: "UPES", location: "Dehradun, Uttarakhand", city: "Dehradun", state: "Uttarakhand", category: "Commerce", logo: "/upes.jfif" },
  { name: "Jaipuria Institute of Management", shortName: "Jaipuria", location: "Noida, Uttar Pradesh", city: "Noida", state: "Uttar Pradesh", category: "Commerce", logo: "/Jaipuria Institute of Management.png" },
  { name: "Harsha Institutions", shortName: "Harsha", location: "Bangalore, Karnataka", city: "Bangalore", state: "Karnataka", category: "Commerce", logo: "/Harsha Institutions.png" },
  { name: "SRU Warangal", shortName: "SRU", location: "Warangal, Telangana", city: "Warangal", state: "Telangana", category: "Commerce", logo: "/sru.jfif" },
  { name: "PIET University", shortName: "PIET", location: "Panipat, Haryana", city: "Panipat", state: "Haryana", category: "Commerce", logo: "/piet.jfif" },
  { name: "Doon Business School", shortName: "DBS", location: "Dehradun, Uttarakhand", city: "Dehradun", state: "Uttarakhand", category: "Commerce", logo: "/Doon Business School.jpeg" },
  { name: "St Andrews Gurgaon", shortName: "St Andrews", location: "Gurgaon, Haryana", city: "Gurgaon", state: "Haryana", category: "Commerce", logo: "/st-andrews.png" },
  { name: "Universal AI University", shortName: "UAI", location: "Mumbai, Maharashtra", city: "Mumbai", state: "Maharashtra", category: "Commerce", logo: "/uai.jfif" },
  { name: "NMIMS", shortName: "NMIMS", location: "All Campuses", city: "Mumbai", state: "Maharashtra", category: "Commerce", logo: "/nmims.png" },
  // Medical
  { name: "American University of Barbados", shortName: "AUB", location: "Barbados (USMLE, ECFMGE)", city: "Barbados", state: "International", category: "Medical", logo: "/aub-logo.png" },
  // Nursing
  { name: "SRM College of Nursing", shortName: "SRM Nursing", location: "Chennai, Tamil Nadu", city: "Chennai", state: "Tamil Nadu", category: "Nursing", logo: "/srm-nursing.png" },
  { name: "Parul University", shortName: "Parul", location: "Vadodara, Gujarat", city: "Vadodara", state: "Gujarat", category: "Nursing", logo: "/parul.jfif" },
  { name: "Manipal College of Nursing", shortName: "Manipal", location: "Manipal, Karnataka", city: "Manipal", state: "Karnataka", category: "Nursing", logo: "/Manipal University.jpeg" },
  { name: "Harsha Institutions", shortName: "Harsha", location: "Bangalore, Karnataka", city: "Bangalore", state: "Karnataka", category: "Nursing", logo: "/Harsha Institutions.png" },
  { name: "NIMS Jaipur", shortName: "NIMS", location: "Jaipur, Rajasthan", city: "Jaipur", state: "Rajasthan", category: "Nursing", logo: "/nims.jfif" },
  { name: "KGMU Lucknow", shortName: "KGMU", location: "Lucknow, Uttar Pradesh", city: "Lucknow", state: "Uttar Pradesh", category: "Nursing", logo: "/kgmu.jfif" },
  { name: "Integral University", shortName: "Integral", location: "Lucknow, Uttar Pradesh", city: "Lucknow", state: "Uttar Pradesh", category: "Nursing", logo: "/integral.jfif" },
  { name: "Chitkara University", shortName: "Chitkara", location: "Punjab", city: "Rajpura", state: "Punjab", category: "Nursing", logo: "/chitkara.jfif" },
  { name: "SGT University", shortName: "SGT", location: "Gurgaon, Haryana", city: "Gurgaon", state: "Haryana", category: "Nursing", logo: "/sgt.jfif" },
  // B Pharma
  { name: "GLA University", shortName: "GLA", location: "Mathura, Uttar Pradesh", city: "Mathura", state: "Uttar Pradesh", category: "B Pharma", logo: "/gla.jfif" },
  { name: "SGT University", shortName: "SGT", location: "Gurgaon, Haryana", city: "Gurgaon", state: "Haryana", category: "B Pharma", logo: "/sgt.jfif" },
  { name: "KIIT Odisha", shortName: "KIIT", location: "Bhubaneswar, Odisha", city: "Bhubaneswar", state: "Odisha", category: "B Pharma", logo: "/kiit.png" },
  { name: "SRM University", shortName: "SRM", location: "Chennai, Tamil Nadu", city: "Chennai", state: "Tamil Nadu", category: "B Pharma", logo: "/srm.png" },
  { name: "Nirma University", shortName: "Nirma", location: "Ahmedabad, Gujarat", city: "Ahmedabad", state: "Gujarat", category: "B Pharma", logo: "/nirma.jfif" },
  { name: "Harsha Institutions", shortName: "Harsha", location: "Bangalore, Karnataka", city: "Bangalore", state: "Karnataka", category: "B Pharma", logo: "/harsha.jfif" },
  { name: "Chandigarh University", shortName: "CU", location: "Chandigarh, Punjab", city: "Chandigarh", state: "Punjab", category: "B Pharma", logo: "/chandigarh.png" },
  // Forensics
  { name: "Parul University", shortName: "Parul", location: "Vadodara, Gujarat", city: "Vadodara", state: "Gujarat", category: "Forensics", logo: "/parul.jfif" },
  { name: "jain University", shortName: "JAIN", location: "Bangalore, Karnataka", city: "Bangalore", state: "Karnataka", category: "Forensics", logo: "/jain.png" },
  { name: "Apex University", shortName: "Apex", location: "Jaipur, Rajasthan", city: "Jaipur", state: "Rajasthan", category: "Forensics", logo: "/apex.jfif" },
  { name: "SGT University", shortName: "SGT", location: "Gurgaon, Haryana", city: "Gurgaon", state: "Haryana", category: "Forensics", logo: "/sgt.jfif" },
  { name: "Integral University", shortName: "Integral", location: "Lucknow, Uttar Pradesh", city: "Lucknow", state: "Uttar Pradesh", category: "Forensics", logo: "/integral.jfif" },
  { name: "Jaipur National University", shortName: "JNU", location: "Jaipur, Rajasthan", city: "Jaipur", state: "Rajasthan", category: "Forensics", logo: "/Jaipur National University.png" },
  { name: "National Forensic Sciences University", shortName: "NFSU", location: "Gandhinagar, Gujarat", city: "Gandhinagar", state: "Gujarat", category: "Forensics", logo: "/nfsu.png" },
  { name: "Christ University", shortName: "CHRIST", location: "Bangalore, Karnataka", city: "Bangalore", state: "Karnataka", category: "Forensics", logo: "/christ.jfif" },
  // BPT
  { name: "LPU Punjab", shortName: "LPU", location: "Jalandhar, Punjab", city: "Jalandhar", state: "Punjab", category: "BPT", logo: "/lpu.jfif" },
  { name: "Chandigarh University", shortName: "CU", location: "Chandigarh, Punjab", city: "Chandigarh", state: "Punjab", category: "BPT", logo: "/chandigarh.png" },
  { name: "SGT University", shortName: "SGT", location: "Gurgaon, Haryana", city: "Gurgaon", state: "Haryana", category: "BPT", logo: "/sgt.jfif" },
  { name: "KIIT Odisha", shortName: "KIIT", location: "Bhubaneswar, Odisha", city: "Bhubaneswar", state: "Odisha", category: "BPT", logo: "/kiit.png" },
  { name: "NIMS Jaipur", shortName: "NIMS", location: "Jaipur, Rajasthan", city: "Jaipur", state: "Rajasthan", category: "BPT", logo: "/nims.jfif" },
  { name: "Parul University", shortName: "Parul", location: "Vadodara, Gujarat", city: "Vadodara", state: "Gujarat", category: "BPT", logo: "/parul.jfif" },
  { name: "GLA University", shortName: "GLA", location: "Mathura, Uttar Pradesh", city: "Mathura", state: "Uttar Pradesh", category: "BPT", logo: "/gla.jfif" },
  // Liberal Arts
  { name: "Bennett University", shortName: "BENNETT", location: "Greater Noida, Uttar Pradesh", city: "Greater Noida", state: "Uttar Pradesh", category: "Liberal Arts", logo: "/BENNETT UNIVERSITY.webp" },
  { name: "Symbiosis School of Liberal Arts", shortName: "SSLA", location: "Pune, Maharashtra", city: "Pune", state: "Maharashtra", category: "Liberal Arts", logo: "/ssla.jfif" },
  { name: "jain University", shortName: "JAIN", location: "Bangalore, Karnataka", city: "Bangalore", state: "Karnataka", category: "Liberal Arts", logo: "/jain.png" },
  { name: "KREA University", shortName: "KREA", location: "Sri City, Andhra Pradesh", city: "Sri City", state: "Andhra Pradesh", category: "Liberal Arts", logo: "/krea.png" },
  { name: "Ashoka University", shortName: "Ashoka", location: "Sonepat, Haryana", city: "Sonepat", state: "Haryana", category: "Liberal Arts", logo: "/ashoka.png" },
  // BA
  { name: "Bennett University", shortName: "BENNETT", location: "Greater Noida, Uttar Pradesh", city: "Greater Noida", state: "Uttar Pradesh", category: "BA", logo: "/BENNETT UNIVERSITY.webp" },
  { name: "Apex University", shortName: "Apex", location: "Jaipur, Rajasthan", city: "Jaipur", state: "Rajasthan", category: "BA", logo: "/apex.jfif" },
  { name: "jain University", shortName: "JAIN", location: "Bangalore, Karnataka", city: "Bangalore", state: "Karnataka", category: "BA", logo: "/jain.png" },
  { name: "SRM University", shortName: "SRM", location: "All Campuses", city: "Chennai", state: "Tamil Nadu", category: "BA", logo: "/srm.png" },
  { name: "Amrita University", shortName: "Amrita", location: "All Campuses", city: "Coimbatore", state: "Tamil Nadu", category: "BA", logo: "/amrita.png" },
  { name: "KIIT Odisha", shortName: "KIIT", location: "Bhubaneswar, Odisha", city: "Bhubaneswar", state: "Odisha", category: "BA", logo: "/kiit.png" },
  { name: "Adamas University", shortName: "Adamas", location: "Kolkata, West Bengal", city: "Kolkata", state: "West Bengal", category: "BA", logo: "/adamas.png" },
  { name: "Brainware University", shortName: "Brainware", location: "Kolkata, West Bengal", city: "Kolkata", state: "West Bengal", category: "BA", logo: "/brainware.jfif" },
];
