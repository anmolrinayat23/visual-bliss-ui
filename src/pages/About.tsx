          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-3 mb-4">
                ...
                <h2 className="text-6xl font-black text-gray-900">Our Vision</h2>
          ...
          <div className="container mx-auto max-w-6xl relative z-10">
            <Card className="p-12 bg-white/95 backdrop-blur-sm border-0  transform hover:scale-105 transition-transform duration-500">
              <div className="text-center mb-8">
                ...
                <h2 className="text-6xl font-black text-gray-900 mb-4">Our Mission</h2>
              </div>
                ...
                <Card key={index} className="group bg-white border-2 border-gray-200 hover:border-blue-300 transition-all duration-500 overflow-hidden">
                  <div className="p-8">
                    ...
                    <div className="space-y-2">
                      <p className="text-gray-600 text-center leading-relaxed text-sm">{member.description}</p>
                      <p className="text-gray-700 text-center font-medium text-sm">{member.achievement}</p>
                    ...
                    <div className="mt-6 text-center">
                      <Button
                        ...
                        className="bg-orange-500 hover:bg-orange-600 text-white font-semibold px-28 py-2 rounded-lg transition-all duration-300 transform hover:scale-105"
                      >
                        Read More
                      </Button>
                    </div>
